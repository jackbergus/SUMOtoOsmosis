...
public class RES_example4_DeviceAgent extends DeviceAgent {
    ...
    public RES_example4_DeviceAgent() {
    ...
    public void plan() {
        ...
        for(AgentMessage message:messages){
            RES_example4_AgentMessage ex4_message = (RES_example4_AgentMessage) message;
